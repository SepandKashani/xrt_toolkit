...
def setOperator(sod, sdd, N_view, N_h, N_w, v_pitch, rx_pitch, dws, shift_cor=0):
    """
    Parameters
    ----------
    sod: float
...
def reconstruct(fpath, dataset, dws, rx_pitch, method = 'pinv', roi='False', shift_cor=0., center_slice='False', max_iter=40, damp=0.1):
    ...
    n_spec, t_spec, v_shape, v_pitch, v_ll, P = setOperator(sod, sdd, v_shape, v_pitch, P, rx_pitch, dws, roi, shift_cor, center_slice)
    return n_spec, t_spec, v_shape, v_pitch, v_ll, P
    W = pxrt.Width.DOUBLE
